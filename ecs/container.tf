resource "aws_ecs_cluster_capacity_providers" "blockparty" {
  cluster_name       = aws_ecs_cluster.blockparty.name
...
resource "aws_ecs_capacity_provider" "spot" {
  ...
  depends_on = [aws_autoscaling_group.this, aws_ecs_cluster.blockparty]
}
...
resource "aws_launch_template" "this" {
  ...
  tag_specifications {
    ...
    tags = {
      Cluster = aws_ecs_cluster.blockparty.name
    }
  }
  lifecycle {
    create_before_destroy = true
